...
class Search:
    """Bayesian Search & Rescue game with 3 search area."""
    ...
    def draw_map(self, last_known):
        """Display basemap with scale, last known xy location, searach areas."""
        ...
        # Draw and nnumber the search areas.
        cv.rectangle(
            self.img,
        ...
        # Post the last known position of the sailor.
